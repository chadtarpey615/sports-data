...
const requests = {
    ...
    // fetchTeams: `https://fly.sportsdata.io/v3/nfl/scores/json/Teams?key=${API_KEY}`,
    fetchTeams: `https://www.fantasyfootballnerd.com/service/nfl-teams/json/${api_key}/`
